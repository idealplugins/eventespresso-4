...
/**
 * Paysafecard plugin for Event Espresso 4
 *
...
class EE_Paysafecard extends EE_Offsite_Gateway {
	...
	public static function instance(EEM_Gateways &$model) {
		...
		if (self::$_instance === NULL or !is_object(self::$_instance) or ! ( self::$_instance instanceof  EE_Paysafecard )) {
        ...
        if (!$payResult) {
			...
			if(!empty($payment)) {
				...
				$payment = EE_Payment::new_instance(array(
					...
					'PAY_method' => sanitize_text_field('Targetpay PaySafeCard'),
